...
namespace ClassLibrary1.Factories
{
    internal static class WorldFactory
    {
        ...
        private static string GAME_DATA_FILENAME = Environment.CurrentDirectory + "/GameData/Worlds/Locations.json";
        ...
        internal static World CreateWorld()
        {
            ...
            if (File.Exists(GAME_DATA_FILENAME))
            {
                ...
                world = JsonConvert.DeserializeObject<World>(content);
            }
            else
            {
        ...
        //            newWorld.AddLocation(100, 100, "Dummie", "", "");
